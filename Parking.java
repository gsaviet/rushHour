...
public class Parking {
	 ...
	 */
	public void addVehicule(String nom, String couleur, int longueur, int posX, int posY, String direction) 
	{
	...
	public void move(String move) 
	{
		...
		vehicule.deplacerVehicule(Character.toString(deplacement[1]),Character.getNumericValue(deplacement[2]));
	}
}
