...
public class Grid implements Constants {
   /**
    * Ce constructeur permet de générer exactment la même grille
    * que celle donnée dans l'énoncé du TD.
    */
   public Grid()
   {
      ...
      for(int i=0;i<6;i++)
         for(int j=0;j<6;j++)
            new Rectangle(SQUARE-BORDER*2,SQUARE-BORDER*2,
                  2*BORDER+j*SQUARE,2*BORDER+i*SQUARE,"grey").makeVisible();
   }
}
